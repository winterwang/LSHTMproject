...
lc1 <- poLCA(f, dta_d2_wide, nclass = 1, graphs = T, maxiter = 10000)

lc2 <- poLCA(f, dta_d2_wide, nclass = 2, graphs = T, maxiter = 10000)





lc3 <- poLCA(f, dta_d2_wide, nclass = 3, graphs = TRUE, maxiter = 10000)
...
lc4 <- poLCA(f, dta_d2_wide, nclass = 4, graphs = TRUE, maxiter = 10000)
...
lc6 <- poLCA(f, dta_d2_wide, nclass = 6, graphs = FALSE,  maxiter = 10000)

lc7 <- poLCA(f, dta_d2_wide, nclass = 7, graphs = FALSE, maxiter = 10000)

lc8 <- poLCA(f, dta_d2_wide, nclass = 8, graphs = FALSE, maxiter = 10000)
