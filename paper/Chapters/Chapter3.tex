...
\begin{table}
	...
	\begin{tabular}[t]{lcccc}
		...
		\multicolumn{5}{l}{{\scriptsize and sglucose syrups, sugars added to food and sugars in fruit juices.}}\\
	\end{tabular}
\end{table}
...
The social-demographic characteristics of the UK adults according to their individual level latent class membership are shown in \textbf{Table \ref{tab:Level2tab1}}. Moderate carbohydrate eaters were relatively younger (\textit{p} < 0.001), and slightly less from England (\textit{p} = 0.007). Gender distribution across the three types of carbohydrate eaters were fairly even (\textit{p} = 0.119). Distribution of the carbohydrate eaters types was changing with the year of survey. Low carbohydrate eaters represented 32.5\% of the population in the first year of survey, but later dropped to lower than 30\% (lowest in the third year, 22.6\%) until the most recent year. Proportion of high carbohydrate eaters increased from 41.2\% to the highest (50.6\%) in the second year of the survey, but then started to decline to 38.4\% in the 8th year of survey (\textit{p} = 0.015). There was no evidence of 
...
95\% CIs of the social-demographic characteristics by latent class memberships in the UK
...
difference in employment status across three types of carbohydrate eaters. However, strong evidence suggested that high carbohydrate eaters had the highest proportion (61.3\%) of living with a partner (\textit{p} < 0.001); low carbohydrate eaters were with the lowest average income (27180.8 \textsterling/year), highest proportion of non-white population (20.5\%), and lower education level (23.3\% with degree of higher education) compared with either low or high carbohydrate eaters. 

Weighted means, percentages of anthropometric measurements, average of main nutrient intake as well as biochemical characteristic profiles of latent carbohydrate eaters groups are given in \textbf{Table \ref{tab:tab2}}. Low carbohydrate eaters were with higher BMI (27.8 kg/m\textsuperscript{2}) and larger WC (94.6 cm) compared with 27.2, 27.3 kg/m\textsuperscript{2}, and 92.3, 92.2 cm in moderate and high carbohydrate eaters. High carbohydrate eaters had the lowest prevalence of being a current smoker (17.1\%). Average total energy intake over the 4 days of dietary survey was the highest (7985.8 kJ) in the low carbohydrate eaters group. As expected, the mean total carbohydrate intake was 203.8 g, 218.3 g, and 233.4 g for low, moderate, and high carbohydrate eaters, respectively. Energy contribution from carbohydrate was close to 50\% in the high carbohydrate eaters, but only 40.6\% in the low carbohydrate eaters. It is noteworthy that low carbohydrate eaters consumed the highest average amount of protein (79.9 g, 17.2\% of total energy), fat (74.7g, 35.4\% of total energy), and alcohol (20.8 g, 6.8\% of total energy). 

From the results of blood tests, 6.9\% of low carbohydrate eaters were found to be diabetes (diagnosed by A1C > 6.5\%), while the number in the moderate and high carbohydrate eaters were 3.5\%, and 4.1\% (\textit{p} < 0.011). Borderline significance (\textit{p} = 0.051) suggested that fasting blood glucose level may be slightly higher in low carbohydrate eaters. Cholesterol, HDL, and LDL were all lower in the moderate carbohydrate eaters, while no evidence of any difference of TG was found across three types of carbohydrate eaters. 
...
\begin{table}[H]
	...
	\textbf{Variables} & \textbf{\Centerstack{Low carbo-\\hydrate eaters\\(n = 1730)}} & \textbf{\Centerstack{Moderate carbo-\\hydrate eaters\\(n = 1772)}} & \textbf{\Centerstack{High carbo-\\hydrate eaters\\(n = 2653)}} & \textbf{\textit{P} value} \textsuperscript{*}\\
		...
		Hypertension\textsuperscript{\dag}, Yes (\%) & 33.4 (29.9, 37.1) & 21.1 (17.7, 24.9) & 31.2 (28.3, 34.2) & < 0.001\\
		...
		Physical
		activity (hours/day) \textsuperscript{\P} & 1.08 (0.97, 1.19) & 0.87 (0.77, 0.97)  & 1.07 (0.98, 1.16) & 0.005 \\
		\bottomrule
%		\multicolumn{5}{l}{\textit{Note: }}\\
		...
		\multicolumn{5}{l}{ the data was positively skewed.} \\
		...
		\multicolumn{5}{l}{{\scriptsize work-related and recreational activities during the survey.}}\\
	\end{tabular}
\end{table}
