...
\begin{table}[H]
	...
	\begin{tabular}[t]{llccccc}
		...
		9 am – 12 noon &  &  &  &  &  & \\
		& Not eating any food & 5447 & 22.3 & 0.237 & 0.079 & 0.401\\
		...
		& Carbohydrate $<$ 50\% & 8898 & 36.4 & 0.266 & 0.551 & 0.212\\
...
%		Alcohol percent (\%) &  6.8 (6.3, 7.4) &  3.8 (3.4, 4.3) & 3.2 (2.9, 3.4)& < 0.001 \\
		...
		\multicolumn{5}{l}{{\scriptsize \textbf{Abbreviations}: CI, confidence intervals; NDNS RP, national diet and nutrition survey rolling programme;}}\\
		\multicolumn{5}{l}{{\scriptsize BMI body mass index; WC, waist circumference; HbA1C, haemoglobin HbA1C; DM, diabetes mellitus; TC, total }}\\
		\multicolumn{5}{l}{{\scriptsize cholesterol; HDL, high density lipoproteins; LDL, low density lipoproteins; TG, triglycerides.}} \\
		\multicolumn{5}{l}{{\scriptsize Glucose, HbA1C, TC, HDL, LDL, TG, and physical activity were expressed in geometric means (95\% CI) because the }} \\
		\multicolumn{5}{l}{ {\scriptsize data were positively skewed.}} \\
...
%			\multicolumn{12}{l}{{\scriptsize DM was defined by HbA1C > 6.5\%. BMI was replaced with WC in Model 2s, other covariates remained the same with the corresponding Model 1s.}}\\
