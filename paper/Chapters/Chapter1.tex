...
More recently, discernible temporal eating patterns that differed by sociodemographic and eating profiles were revealed using latent class analysis from nutrition survey data. 


 there are distinct temporal eating patterns that differed by sociodemographic in Australian men and women and 



(some review of articles about eating time)
