...
\NormalTok{NDAYS14 <-}\StringTok{ }\NormalTok{blood14 }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(ID, Ndays)}

\NormalTok{NDAYS56 <-}\StringTok{ }\NormalTok{blood56 }\OperatorTok{\%>\%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(ID, Ndays)}

\NormalTok{NDAYS78 <-}\StringTok{ }\NormalTok{blood78 }\OperatorTok{\%>\%}\StringTok{ }
...
\NormalTok{NDAYS <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(NDAYS14, NDAYS56, NDAYS78)}
...
\KeywordTok{write_dta}\NormalTok{(CW3CB3_7regss, }\StringTok{"../CW3CB3_7regss.dta"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
