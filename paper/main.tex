...
\textbf{Background:}
Recent evidence suggested that there are 3 types of eaters (grazers, early eaters, and late eaters) in the general population according to the timing of their energy consumption occurred throughout the day. This project aimed at investigating the relationship between the timing of eating and carbohydrate intake. Additionally, associations between carbohydrate eating patterns defined previously and hypertension, obesity were explored.

\textbf{Methods:}
The National Diet and Nutrition Survey (NDNS) Rolling Programme (2008/09-15/16) database of detailed four-day food diaries was used in exploration of both timing and quantity eating patterns of carbohydrates in the general adults living in the UK. 6155 participants aged 19 or older were kept in the analysis. Multilevel latent class analysis (MLCA) models were applied in finding the latent classes of carbohydrate consumption accounting for the hierarchical data structure that the observed daily food diaries nested within individuals. Survey-designed multivariable regression models assessed the associations of carbohydrate eating patterns with hypertension, body mass index (BMI), and waist circumferences.

\textbf{Results:}
Three types of carbohydrate eating days (low/high percentage carbohydrate days, and regular meal days) were found in the elementary level, depending on which, three types of carbohydrate eaters (low/moderate/high carbohydrate eaters) emerged in the NDNS RP participants. 
