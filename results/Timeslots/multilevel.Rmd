...
date: "29 July 2018, Updated at `r Sys.Date()`"
output: 
  html_document:
    toc: true
    toc_depth: 3
...
```{r echo=FALSE, fig.height=8, fig.width=14, message=FALSE, warning=FALSE, cache=TRUE}
library(ggthemr)
ggthemr("fresh", layout = "scientific")
library(ggplot2)


ggplot(pp_long[pp_long$CW == 1, ], aes(y = Prob, x=Slots, group = Carbo, color = Carbo)) + 
  geom_point(size = 3) + 
  geom_line(size = 1.5) + 
  ...
  labs(title = "Class 1 days", x = "Time slots of the day", y = "Probability",
       color = "Carbohydrate\nintake") + 
...
ggplot(pp_long[pp_long$CW == 2, ], aes(y = Prob, x=Slots, group = Carbo, color = Carbo)) + 
  geom_point(size = 3) + 
  geom_line(size = 1.5) + 
  theme(axis.title = element_text(size = 18), 
        axis.text = element_text(size = 18), 
      ...
      theme(axis.text.x = element_text(angle = 60, hjust = 1)) + 
  labs(title = "Class 2 days", x = "Time slots of the day", y = "Probability",
       color = "Carbohydrate\nintake") + 
  scale_color_discrete(labels = c("Not eating", "< 50%", ">= 50%")) + 
  ylim(c(0,1))
...
ggplot(pp_long[pp_long$CW == 3, ], aes(y = Prob, x=Slots, group = Carbo, color = Carbo)) + 
  geom_point(size = 3) + 
  geom_line(size = 1.5) + 
  theme(axis.title = element_text(size = 18), 
        axis.text = element_text(size = 18), 
      ...
      theme(axis.text.x = element_text(angle = 60, hjust = 1)) + 
  labs(title = "Class 3 days", x = "Time slots of the day", y = "Probability",
       color = "Carbohydrate\nintake") + 
  scale_color_discrete(labels = c("Not eating", "< 50%", ">= 50%")) + 
  ylim(c(0,1))
