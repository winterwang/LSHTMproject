...
ggplot(pp[pp$C == 1, ], aes(y = Prob, x=DHourN, group = Carbo, color = Carbo)) + 
  ...
  labs(title = "Class 1: 43.9%", x = "Hour of the day", y = "Probability",
       color = "Carbohydrate\nintake") + 
...
ggplot(pp[pp$C == 2, ], aes(y = Prob, x=DHourN, group = Carbo, color = Carbo)) + 
  ...
  labs(title = "Class 2: 56.1%", x = "Hour of the day", y = "Probability",
       color = "Carbohydrate\nintake") + 
  scale_color_discrete(labels = c("Not eating\nany food", "< 50%", ">= 50%")) + 
  ylim(c(0,1)) + 
  # theme(axis.text.x = element_text(angle = 90, hjust = 1)) + 
...
ggplot(pp[pp$C == 1, ], aes(y = Prob, x=DHourN, group = Carbo, color = Carbo)) + 
  ...
  labs(title = "Class 1: 67.2%", x = "Hour of the day", y = "Probability",
       color = "Carbohydrate\nintake") + 
  scale_color_discrete(labels = c("Not eating\nany food", "< 50%", ">= 50%")) + 
  ylim(c(0,1)) + 
  # theme(axis.text.x = element_text(angle = 90, hjust = 1)) + 
...
ggplot(pp[pp$C == 2, ], aes(y = Prob, x=DHourN, group = Carbo, color = Carbo)) + 
  ...
  labs(title = "Class 2: 21.9%", x = "Hour of the day", y = "Probability",
       color = "Carbohydrate\nintake") + 
  scale_color_discrete(labels = c("Not eating\nany food", "< 50%", ">= 50%")) + 
  ylim(c(0,1)) + 
  # theme(axis.text.x = element_text(angle = 90, hjust = 1)) + 
...
ggplot(pp[pp$C == 3, ], aes(y = Prob, x=DHourN, group = Carbo, color = Carbo)) +
  ...
  labs(title = "Class 3: 10.9%", x = "Hour of the day", y = "Probability",
       color = "Carbohydrate\nintake") + 
  scale_color_discrete(labels = c("Not eating\nany food", "< 50%", ">= 50%")) + 
  ylim(c(0,1)) + 
  # theme(axis.text.x = element_text(angle = 90, hjust = 1)) + 
